 ...
 */
public final class BitcoinCommand implements Command {
    ...
    public ArrayList<String> getCommandAliases() {
        return new ArrayList<>(Arrays.asList("btc", "ltc", "eth"));
    }
